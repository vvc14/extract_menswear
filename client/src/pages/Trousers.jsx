...
export default function Trousers() {
    ...
    const fetchProducts = useCallback(async (f) => {
        setLoading(true);
        try {
            const qs = buildQueryString({ ...f, category: "trouser", sort: sortBy });
        ...
        <main id="main-content">
            ...
            <section style={{ background: "#1a2744" }} className="relative overflow-hidden">
                <div className="absolute inset-0">
                    <img src="https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=1920&q=60" alt="" className="w-full h-full object-cover" style={{ opacity: 0.1 }} />
                ...
                <div className="relative page-wrap py-16 sm:py-24">
                    <nav aria-label="Breadcrumb" className="mb-6">
                        <ol className="flex items-center gap-2 text-[13px]">
                            ...
                            <li className="font-semibold text-slate-300">Trousers</li>
                        </ol>
                    </nav>
                    <p className="section-label" style={{ color: "#c9a84c", marginBottom: "1rem" }}>Men's Collection</p>
                    <h1 className="text-[34px] sm:text-[46px] font-extrabold text-white tracking-tight mb-4">Trousers Collection</h1>
                        ...
                        {loading ? (
                            ...
                            <div className="flex items-center justify-center" style={{ minHeight: "50vh" }}>
                                <div className="text-center">
                                    ...
                                    <p className="text-[26px] font-extrabold text-slate-900 dark:text-white mb-3">No trousers found</p>
                                    ...
                                    <Link to="/shirts" className="inline-flex items-center gap-2 text-[16px] font-bold text-primary dark:text-gold hover:text-primary-dark dark:hover:text-gold-dark transition-colors">
