...
export default function Shirts() {
    ...
    const fetchProducts = useCallback(async (f) => {
        setLoading(true);
        try {
            const qs = buildQueryString({ ...f, category: "shirt" });
        ...
        <main id="main-content">
            ...
            <section className="relative bg-slate-900 overflow-hidden">
                <div className="absolute inset-0 opacity-20">
                    <img src="https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=1920&q=60" alt="" className="w-full h-full object-cover" />
                </div>
                ...
                <div className="relative max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 py-14 sm:py-20">
                    <nav aria-label="Breadcrumb" className="mb-5">
                        <ol className="flex items-center gap-2 text-[15px]">
                            ...
                            <li className="text-white font-semibold">Shirts</li>
                        </ol>
                    </nav>
                    <h1 className="text-[34px] sm:text-[44px] font-extrabold text-white tracking-tight mb-4">Shirts Collection</h1>
                    ...
                    <div className="flex-1">
                        {loading ? (
                            ...
                            <div className="text-center py-28 bg-white rounded-2xl border border-slate-200">
                                ...
                                <p className="text-[26px] font-extrabold text-slate-900 mb-3">No shirts found</p>
                                ...
                                <Link to="/trousers" className="inline-flex items-center gap-2 text-[16px] font-bold text-primary hover:text-primary-dark transition-colors">
